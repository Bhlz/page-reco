...
export default function Footer() {
  ...
  return (
    <footer className="border-t">
        ...
        <div className="grid gap-8 md:grid-cols-3">
          ...
          <div className="text-sm">
            ...
            <ul className="mt-2 space-y-1">
              <li><a href="/envios" className="hover:underline">Envíos y devoluciones</a></li>
              <li><a href="/privacidad" className="hover:underline">Política de privacidad</a></li>
              <li><a href="/facturacion" className="hover:underline">Facturación</a></li>
            </ul>
          </div>
          <div className="text-sm">
      ...
      <div className="container mt-6 text-xs text-neutral-500">
    <a className="underline" href="/admin">Acceso administrador</a>
  </div>
</footer>
  );
}
